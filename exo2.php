...
//     echo strtoupper($pays). "  " .ucfirst($ville)."<br>" ;
//     echo <table>$ville</table>;
// }
// function afficherTableHTML(array $pays){
...
?>
   <!-- definir les trois type de de tableau en programation -->
<!-- $capitale est un tableau associative car il à clé et valeur-->
<!-- tableau simple -->
 <!-- tableau mutifonctionnelle -->